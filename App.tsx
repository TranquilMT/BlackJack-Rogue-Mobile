        ...
        <>
          <BlackjackTable.DealerHandContainer>
              {dealerHand.cards.length > 0 && 
                <BlackjackTable.Hand hand={dealerHand} isPlayer={false} isDealer={true} handIndex={0} isActive={gamePhase === 'dealerTurn'} totalPlayerHands={playerHands.length} cardBack={customization.cardBack} hideSecondCard={gamePhase === 'playerTurn'} />}
          </BlackjackTable.DealerHandContainer>
